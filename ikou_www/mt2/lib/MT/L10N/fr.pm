...
#
# $Id: fr.pm 1035 2007-01-18 17:35:53Z mschenk $
...
%Lexicon = (
    ...
    'Multiple feeds were discovered. Select the feed you wish to use. Feeds.App Lite supports text-only RSS 1.0, 2.0 and Atom feeds.' => 'Plusieurs flux ont été découverts. Sélectionnez le flux que vous souhaitez utliser. Feeds.App Lite supporte les formats  text-only RSS 1.0, 2.0 et Atom.',
    ...
    'Delete' => 'Supprimer',
    'Delete selected Widget Managers (x)' => 'Effacer les Widgets Managers sélectionnés (x)',
    ...
    'Your mail configuration is complete. To finish with the configuration wizard, press \'Continue\' below.' => 'La configuration email est terminée. Pour conclure, cliquez sur le bouton \'Continuer\' ci-dessous.',
    ...
    'You must set your Username.' => 'Vous devez choisir un nom d\'utilisateur.',
    ...
    'To enable comment registration, you need to add a TypeKey token in your weblog config or author profile.' => 'Pour activer l\'authentification des commentaires, vous devez ajouter une clé TypeKey dans la config de votre weblog ou dans le profil de l\'auteur.',
    ...
    'Assigning author types...' => 'Ajout des types d\'auteurs...',
...
S\'il s\'agit d\'une erreur, vous pouvez annuler le bannissement de l\'adresse IP dans Movable Type, sous Configuration du weblog > Bannissement d\'adresses IP, et en supprimant l\'adresse IP [_4] de la liste des addresses bannies.',
    ...
    'Updating author web services passwords...' => 'Mise à jour des mots de passe des services web de l\'auteur...',
    ...
    '_USAGE_NEW_AUTHOR' => ' A partir de cette page vous pouvez créer de nouveaux auteurs dans le système et définir leurs accès dans un ou plusieurs weblogs.',
    ...
    'Failed login attempt by unknown user \'[_1]\'' => 'Echec d\'identification par un utilisateur inconnu \'[_1]\'',
    'Failed login attempt with incorrect password by user \'[_1]\' (ID: [_2])' => 'Echec d\'identification avec mot de passe incorrect par l\'utilisateur \'[_1]\' (ID: [_2])',
    ...
    'Invalid username \'[_1]\' in password recovery attempt' => 'Nom d\'utilisateur incorrect \'[_1]\' pendant la tentative de récupération du mot de passe',
    'Username or password recovery phrase is incorrect.' => 'Le nom d\'utilisateur ou la phrase de récupération du mot de passe sont incorrects.',
