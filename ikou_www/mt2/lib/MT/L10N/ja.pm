...
#
# $Id: ja.pm 1030 2007-01-17 17:17:56Z fumiakiy $
...
%Lexicon = (
    ...
    'DBI and DBD::SQLite2 are required if you want to use the SQLite2 database backend.' => 'DBIとDBD::SQLite2は、SQLite2を使ってブログのデータを管理するために必要です。',
    ...
    'Many more can be found on the <a href="[_1]">main index page</a> or by looking through <a href="[_2]">the archives</a>.' => '他にも多くのエントリーがあります。<a href="[_1]">メインページ</a>や<a href="[_2]">アーカイブページ</a>も見てください。',
    'This page contains a single entry from the blog posted on <strong>[_1]</strong>.' => '[_1]に投稿されたエントリーのページです。',
    ...
    "Entries from [_1] tagged with '[_2]'" => 'ブログ: [_1] でタグ: [_2] が指定されているエントリー',
    ...
    "Entries matching '[_1]'" => '[_1] を含むエントリー',
    "Entries tagged with '[_1]'" => 'タグ: [_1] が指定されているエントリー',
    ...
    "If you use an RSS reader, you can subscribe to a feed of all future entries tagged '[_1]'." => 'フィードリーダーを利用して検索結果を購読し、今後投稿されるエントリーでタグ「[_1]」が指定されているものにアクセスできます。',
    "If you use an RSS reader, you can subscribe to a feed of all future entries matching '[_1]'." => 'フィードリーダーを利用して検索結果を購読し、今後投稿されるエントリーで「[_1]」にマッチするものにアクセスできます。',
    ...
    'Setting new entry defaults for weblogs...' => 'エントリー投稿画面の新しい既定値を設定しています...',
    ...
    'TrackBack Activity Feed' => 'トラックバック・ログ・フィード',
    'No Excerpt' => '概要がありません',
    'No Title' => 'タイトルがありません',
    ...
    'No valid recipients found for the entry notification.' => 'エントリーの通知先がありません。',
    ...
    "Entries from [_1] tagged with '[_2]'" => '[_1]でタグ [_2] が指定されているエントリー',
    'Posted <MTIfNonEmpty tag="EntryAuthorDisplayName">by [_1] </MTIfNonEmpty>on [_2]' => '<MTIfNonEmpty tag="EntryAuthorDisplayName">投稿者: [_1]  </MTIfNonEmpty>日時: [_2]',
    'No pages were found containing "[_1]".' => '[_1] を含むページが見つかりませんでした。',
    ...
    "Your mail configuration is complete. To finish with the configuration wizard, press 'Continue' below." => 'メールの構成を完了しました。次へをクリックして先に進んでください。',
    'Back' => '戻る',
    'Continue' => '次へ',
    ...
    'Movable Type ships with directory named <strong>mt-static</strong> which contains a number of important files such as images, javascript files and stylesheets.' => 'Movable Type にはmt-staticというディレクトリが含まれています。このディレクトリには、画像ファイル、JavaScriptやスタイルシートなどの重要なファイルが含まれています。',
    ...
    'You must set your Database Name.' => 'データベース名が入力されていません。',
    'You must set your Database Path.' => 'データベースファイルへのパスが入力されていません。',
    'You must set your Username.' => 'ログイン名が入力されていません。',
    'You must set your Database Server.' => 'データベースサーバーが入力されていません。',
    ...
    'Movable Type' => 'Movable Type',
    'Movable Type Configuration Wizard' => 'Movable Type 構成ウィザード',
    ...
    'You have unsaved changes to your entry that will be lost.' => '保存されていないエントリーへの変更は失われてしまいます。',
    ...
    'Comment Pending Message' => 'コメント・保留',
    ...
    'Entry Editor Display Options' => 'エントリー投稿画面の設定',
    ...
    'A new version of Movable Type has been installed.  We\'ll need to complete a few tasks to update your database.' => 'Movable Typeの最新版のインストールが終了しました。次にデータベースのアップグレードを行います。ボタンをクリックして先に進んでください。',
