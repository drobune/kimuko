...
#
# $Id: mt.php.pre 60246 2007-08-06 01:12:40Z fyoshimatsu $

define('VERSION', '4.0');
define('VERSION_ID', '4.0');
...
class MT {
    ...
    function load_plugin($plugin_dir) {
        ...
        ini_set('include_path', $plugin_dir . $path_sep . ini_get('include_path'));
