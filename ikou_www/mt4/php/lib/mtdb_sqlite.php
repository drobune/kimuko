...
#
# $Id: mtdb_sqlite.php 55950 2007-06-13 09:03:15Z ytakayama $
...
/*
    function archive_list_sql($args) {
        ...
        if ($at == 'Daily') {
            $sql = "
                select count(*),
                       strftime('%Y', entry_authored_on),
                       strftime('%m', entry_authored_on),
                       strftime('%d', entry_authored_on)
                  from mt_entry
                 ...
                 group by
                       ...
                       strftime('%d', entry_authored_on)
                 order by
                       strftime('%Y', entry_authored_on) $order,
                       strftime('%m', entry_authored_on) $order,
                       strftime('%d', entry_authored_on) $order
                 $limitStr";
        } elseif ($at == 'Weekly') {
            $sql = "
                select count(*),
