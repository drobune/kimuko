$(document).ready(function(){
	...
	$.timer(9000, function (timer) {
		...
		switch(current_panel){
			case 1:
				$("#slideshow").stop().animate({left: "-454px", top: "0px"}, {easing: 'easeOutBack', duration: animation_duration});
				current_panel = 2;
			break;
			case 2:
			...
			break;
			case 3:
				$("#slideshow").stop().animate({left: "-450px", top: "-130px"}, {easing: 'easeOutBack', duration: animation_duration});
				current_panel = 4;
			break;
			case 4:
